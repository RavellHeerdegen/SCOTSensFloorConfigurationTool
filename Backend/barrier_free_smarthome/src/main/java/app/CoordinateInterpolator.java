...
public abstract class CoordinateInterpolator {

    Logger logger = LoggerFactory.getLogger(CoordinateInterpolator.class);
    ...
    public CoordinateInterpolator(long timeStepMillis){
